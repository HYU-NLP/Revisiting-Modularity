...
def main():
    ...
    if os.path.exists(os.path.join(base_directory, "result", "2shot_mc", result_file)):
        return
    ...
    write_dict_to_jsonl(result_data, os.path.join(base_directory, "result", "2shot_mc", result_file))
