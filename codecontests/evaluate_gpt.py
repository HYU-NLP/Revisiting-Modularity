...
def main():
    ...
    result_file = f"{args.model}_{args.code_type}_code_{args.num_icl_shot}shot_{args.num_gen}gen_{args.seed}seed_icl_result.jsonl"
    
    if not os.path.exists(os.path.join(base_directory, "result/gpt", result_file)):
        print('result file does not exist')
        return
    
    if os.path.exists(os.path.join(base_directory, "result/gpt/result", result_file)):
        print('result file already exists')
        return
    
    result_data = read_jsonl_to_dict(os.path.join(base_directory, "result/gpt", result_file))
    print(f'result file path:')
    print(os.path.join(base_directory, "result/gpt/", result_file))
    ...
    write_dict_to_jsonl(result_data, os.path.join(base_directory, "result/gpt/result", result_file))
