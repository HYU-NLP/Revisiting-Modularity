...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if extension == "jsonl": ##
            extension = "json" ##
            # dataset_args["keep_linebreaks"] = data_args.keep_linebreaks ## error in ipynb
        raw_datasets = load_dataset(
            extension,
    ...
    # print(f'len(tokenized_datasets_train): {len(tokenized_datasets["train"])}')
    # print(len(tokenized_datasets['train'][0]['input_ids']))
    # print(len(tokenized_datasets['train'][1]['input_ids']))
    # print(len(tokenized_datasets['train'][2]['input_ids']))
